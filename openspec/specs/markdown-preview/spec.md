# Markdown Preview Spec

## Purpose

Provide a Markdown preview capability within Emacs that renders `.md` files (including mermaid diagrams) to HTML, with keybindings for quick access and two-way editing of mermaid blocks.
